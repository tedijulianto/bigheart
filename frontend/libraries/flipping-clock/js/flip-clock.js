    ...
    FlipClock.Factory = FlipClock.Base.extend({
        ...
        loadClockFace: function (name, options) {
            ...
            if (FlipClock[name]) {
                ...
                face = new FlipClock[this.defaultClockFace + suffix](
                    this,
                    options
                );
            }
...
(function ($) {
    ...
    FlipClock.List = FlipClock.Base.extend({
        ...
        createList: function () {
            var lastDigit = this.getPrevDigit()
                ? this.getPrevDigit()
                : this.digit;
...
(function ($) {
    ...
    FlipClock.Time = FlipClock.Base.extend({
        ...
        getDateObject: function () {
            ...
            return new Date(
                new Date().getTime() + this.getTimeSeconds() * 1000
            );
        },
...
(function ($) {
    ...
    FlipClock.TwentyFourHourClockFace = FlipClock.Face.extend({
        ...
        build: function (time) {
            ...
            $(this.dividers[0]).insertBefore(
                this.lists[this.lists.length - 2].$el
            );
            $(this.dividers[1]).insertBefore(
...
(function ($) {
    ...
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
        ...
        build: function (time) {
            ...
            time = time
                ? time
                : this.factory.time.getDayCounter(this.showSeconds);
...
(function ($) {
    ...
    FlipClock.HourlyCounterFace = FlipClock.Face.extend({
        ...
        build: function (excludeHours, time) {
            ...
            if (!excludeHours) {
                $(this.createDivider("Hours", true)).insertBefore(
                    this.lists[0].$el
                );
            }
